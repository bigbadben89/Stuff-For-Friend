...
// ============================================================================
// SLOT MANAGEMENT - Type 80 (Weapon Skin) -> Slot 17
// ============================================================================
...
__declspec(naked) void ItemEquip() {
	__asm {
		// ebx contains the item type at this hook point
		// type 80 = WeaponSkin/ShieldSkin -> slot 17
...
// HOOK INITIALIZATION
// ============================================================================
// Note: Weapon skin appearance on login/respawn/map change is handled by
// CostumeEffect.cpp hooks which call ApplyWeaponSkin()

void hook::WeaponSkin_Slot() {
	BYTE bySlotCap = 18;  // Only need slot 17 for type 80 (weapon/shield skin)
	//new slots
