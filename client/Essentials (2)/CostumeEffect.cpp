...
std::array<int, 512> Costume_Effect_Array_1 = { 1 };
std::array<int, 512> Costume_Effect_Array_2 = { 2 };
std::array<int, 512> Costume_Effect_Array_3 = { 3 };
std::array<int, 512> Costume_Effect_Array_4 = { 4 };
std::array<int, 512> Costume_Effect_Array_5 = { 5 };
std::array<int, 512> Costume_Effect_Array_6 = { 6 };
std::array<int, 512> Costume_Effect_Array_7 = { 7 };
std::array<int, 512> Costume_Effect_Array_8 = { 8 };
std::array<int, 512> Costume_Effect_Array_9 = { 9 };
std::array<int, 512> Costume_Effect_Array_10 = { 10 };
